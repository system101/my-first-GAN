...
def read_data_sets(train_dir,
  ...
  eminst_train_images, eminst_train_labels = extract_training_samples('letters')
...
def makes_one_hot_vectors(array):
    temp = array
    one_hot_vector = numpy.zeros((temp.size,temp.max()+1))
    one_hot_vector[numpy.arange(temp.size),temp] = 1
